export const countryOptions = [
  ...
  { label: "Bonaire, Sint Eustatius and Saba[c]", value: "BQ" },
  ...
  { label: "Saint Helena, Ascension and Tristan da Cunha[d]", value: "SH" },
  ...
  { label: "Svalbard and Jan Mayen[e]", value: "SJ" },
  ...
  { label: "United States Minor Outlying Islands[f]", value: "UM" },
